...
DEFAULT_SAVE_ITERATIONS = [50, 100, 200, 500]
...
def run_style_transfer(content_path,
  ...
  style_features, content_features = get_feature_representations(model, content_path, style_path, len(content_layers), len(style_layers))
